                  ...
                  <div className="col-xl-6 col-xxl-12">
                    <div className="blog-content">
                      ...
                      <span className="fs-18 font-w400">
                        <small className="text-primary">Admin</small> - 2
                        January 2022
                      </span>
                    </div>
                  </div>
