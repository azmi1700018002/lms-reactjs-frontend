...
const sliderData = [{ image: pic2 }, { image: pic3 }, { image: pic4 }];
          ...
          <div className="row">
            {widgetBlog.map((item, ind) => (
              <div className="col-xl-4 col-xxl-6 col-sm-6" key={ind}>
                <div
                  className={`card  widget-courses style-2 ${item.changeClass}`}
                >
            ...
            <div className="col-xl-12">
              ...
              <Swiper
                className="swiper front-view-slider"
                speed={1500}
                slidesPerView={3}
                spaceBetween={20}
                loop={false}
                  ...
                  <div className="courses-chart d-flex justify-content-between flex-wrap">
                    ...
                    >
                      ...
                      <rect
                        ...
                        height="30.5652"
                        rx="3"
                        transform="rotate(90 30.5654 16)"
                        fill="#FEC64F"
                      />
                      <rect
                        x="59.478"
