        ...
        <Col xl={6} className="col-xxl-12">
          <Card>
            <Card.Header className="d-block">
              ...
              <Card.Text className="subtitle mb-0">
                add <code>.solid</code> className to change the solid color.
              </Card.Text>
            </Card.Header>
            <Card.Body>
          ...
          <Card>
            <Card.Header className="d-block">
              ...
              <p className="mb-0 subtitle">
                add <code>.alert-square</code> className to change the solid
                color.
              </p>
            </Card.Header>
            <Card.Body>
        ...
        <Col xl={6} className="col-xxl-12">
          <Card>
            <Card.Header className="d-block">
              ...
              <p className="mb-0 subtitle">
                add <code>.alert-rounded</code> className to change the solid
                color.
              </p>
            </Card.Header>
            <Card.Body>
        ...
        <Col xl={6} className="col-xxl-12">
          <Card>
            <Card.Header className="d-block">
              ...
              <p className="mb-0 subtitle">
                add <code>.alert-alt</code> className to change the solid color.
              </p>
            </Card.Header>
            <Card.Body>
              {alt.map((data, i) => (
        ...
        <Col xl={6} className="col-xxl-12">
          <Card>
            <Card.Header className="d-block">
              ...
              <p className="mb-0 subtitle">
                add <code>.alert-alt.solid</code> className to change the solid
                color.
              </p>
            </Card.Header>
            <Card.Body>
