              ...
              <Row className="justify-content-between">
                ...
                <Col lg={4}>
                  ...
                  <div className="card-content">
                    <p className="text-muted">
                      This is an example of muted text. Add className{" "}
                      <code>text-muted</code>
                    </p>
                    <p className="text-primary">
                      This is an example of primary text. Add className{" "}
                      <code>text-primary</code>
                    </p>
                    <p className="text-success">
                      This is an example of success text. Add className{" "}
                      <code>text-success</code>
                    </p>
                    <p className="text-info">
                      This is an example of info text. Add className{" "}
                      <code>text-info</code>
                    </p>
                    <p className="text-warning">
                      This is an example of warning text. Add className{" "}
                      <code>text-warning</code>
                    </p>
                    <p className="text-danger">
                      This is an example of danger text. Add className{" "}
                ...
                <Col lg={4} className=" mb-3">
                  <div className="mb-4">
                    ...
                    <p>
                      Use className <code>list-icons</code> to ul for get desire
                      ol list.
                    </p>
                  </div>
