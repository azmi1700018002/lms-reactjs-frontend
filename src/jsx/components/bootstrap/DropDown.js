        ...
        <Col xl={4} lg={12}>
          <Card>
            <Card.Header className="d-block">
              ...
              <Card.Text className="m-0 subtitle">
                The <code>.dropdown-divider</code> className is used to separate
        ...
        <Col xl={4} lg={12}>
          <Card>
            <Card.Header className="d-block">
              ...
              <Card.Text className="m-0 subtitle">
                The <code>.dropdown-header</code> className is used to add
          ...
          <Card>
            <Card.Header className="d-block">
              ...
              <Card.Text className="m-0 subtitle">
                ...
                <code>.dropdown-menu-end</code> className to the element with
                .dropdown-menu
              </Card.Text>
            </Card.Header>
            <Card.Body>
        ...
        <Col xl={4} lg={12}>
          <Card>
            <Card.Header className="d-block">
              ...
              <Card.Text className="m-0 subtitle">
                The <code>.dropup</code> className makes the dropdown menu
        ...
        <Col lg={12}>
          <Card>
            <Card.Header className="d-block">
              ...
              <Card.Text className="m-0 subtitle">
                Use <code>.custom-dropdown</code> this className for this style
              </Card.Text>
            </Card.Header>
            <Card.Body>
              <Row>
