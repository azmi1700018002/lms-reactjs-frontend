      ...
      <div className="row">
        <div className="col-xl-6">
          <div className="widget-heading d-flex justify-content-between align-items-center">
            <h3 className="m-0">Ongoing className</h3>
          </div>
          <div className="row">
                  ...
                  <div className="card-body">
                    <div className="widget-courses align-items-center d-flex flex-wrap">
                      <div className="d-flex align-items-center flex-wrap flex-1">
                        <span className={`schedule-icon ${data.changeClass2}`}>
                          {data.value}%
                        </span>
                        <div className="flex-1">
                          ...
                          <div className="progress-box me-3">
                            <div className="progress mb-0">
                              <div
                                className={`progress-bar ${data.changeClass}`}
                                style={{
            ...
            <div className="col-xl-12 mb-4">
              ...
              <div className="card">
                <div className="card-body">
                  <div id="calendar" className="app-fullcalendar1">
                    <InstructorCalendar />
                  </div>
                </div>
              </div>
