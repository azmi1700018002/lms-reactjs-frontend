                ...
                <div className="instructors-media">
                  ...
                  <div className="instructors-media-info">
                    ...
                    <div className="custome-badge">
                      <Link to={"#"}>
                        <span className="badge badge-xl">Design</span>
                      </Link>
                      <Link to={"#"}>
                        <span className="badge badge-xl">Tech</span>
                      </Link>
                      <Link to={"#"}>
                        <span className="badge badge-xl">Research</span>
                      </Link>
                    </div>
                    <div className="d-flex justify-content-center my-3">
                      <div className="info-box">
                        <span>
                          <img src={medal} alt="" /> Achievement
                        </span>
                        <h4>100</h4>
                      </div>
                      <div className="info-box">
